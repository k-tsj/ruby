...
RUBY_SYMBOL_EXPORT_END
int rb_thread_method_id_and_class(rb_thread_t *th, ID *idp, ID *callee_idp, VALUE *klassp);
...
int rb_vm_control_frame_id_and_class(const rb_control_frame_t *cfp, ID *idp, ID *callee_idp, VALUE *klassp);
...
ruby_exec_event_hook_orig(rb_thread_t *const th, const rb_event_flag_t flag,
			  VALUE self, ID id, ID callee_id, VALUE klass, VALUE data, int pop_p)
{
